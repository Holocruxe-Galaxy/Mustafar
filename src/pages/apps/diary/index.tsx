  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& .MuiSwitch-thumb:before': {
        backgroundImage: `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 20 20">${
          `<path d="M0 19.4442L4.72328 14.7903L12.765 13.3652L11.9701 17.574L1.09844 20.9155L0.396016 20.612L0 19.4442Z" fill="${encodeURIComponent(
              '#2B2C4B'
            )}"/>`
        }${
          ...
          `<path opacity="0.5" d="M10.7682 9.01528C10.5254 9.2841 10.6034 9.68301 10.8289 9.83043C11.0544 9.97785 11.3926 9.9634 11.5573 9.76106C11.7047 9.57895 11.7221 9.21473 11.4966 8.98926C11.3001 8.79559 10.9243 8.84184 10.7682 9.01528Z" fill="white"/>`
        }${
          `<path d="M4.41897 9.39041C4.09811 9.71127 4.08365 10.2258 4.44209 10.5206C4.76006 10.7837 5.27748 10.6131 5.47115 10.3761C5.66483 10.1391 5.6417 9.62455 5.38443 9.37018C5.12717 9.11291 4.61553 9.19674 4.41897 9.39041Z" fill="white"/>`
        }${
          `<path d="M24.7421 9.94655C23.132 8.46366 20.8918 8.86257 19.7876 10.1807C18.6544 11.5393 18.7383 13.6148 20.0766 14.8635C21.2936 15.9966 23.5569 16.2539 24.9213 14.6641C26.1354 13.2534 26.0602 11.1577 24.7421 9.94655Z" fill="${encodeURIComponent(
            '#E1E1E1'
          )}"/>`
        }${
