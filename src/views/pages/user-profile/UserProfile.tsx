...
// ** Type Import
import { TeamsTabType, ProfileTabType, ConnectionsTabType, UserProfileActiveTab } from 'src/@fake-db/types'
        ...
        <Grid item xs={12}>
          <TabContext value={activeTab}>
            <Grid container spacing={6}>
              ...
              <Grid item xs={12}>
                {isLoading ? (
                  <Box sx={{ mt: 6, display: 'flex', alignItems: 'center', flexDirection: 'column' }} component='div'>
