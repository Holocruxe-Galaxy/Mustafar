    ...
    <Card>
      ...
      <CardContent>
        <Box component='div' sx={{ mb: 4, display: 'flex', flexWrap: 'wrap' }}>
          <Box
            component='div'
            sx={{ mr: 6, display: 'flex', alignItems: 'center', '& svg': { mr: 1.5, color: '#826af9' } }}
          >
          ...
          <Box
            component='div'
            sx={{ mr: 6, display: 'flex', alignItems: 'center', '& svg': { mr: 1.5, color: '#9f87ff' } }}
          >
            <Icon icon='mdi:circle' fontSize='0.75rem' />
          ...
          <Box
            component='div'
            sx={{ mr: 6, display: 'flex', alignItems: 'center', '& svg': { mr: 1.5, color: '#d2b0ff' } }}
          >
            <Icon icon='mdi:circle' fontSize='0.75rem' />
            <Typography variant='body2'>Oneplus</Typography>
          </Box>
          <Box component='div' sx={{ display: 'flex', alignItems: 'center', '& svg': { mr: 1.5, color: '#f8d3ff' } }}>
            <Icon icon='mdi:circle' fontSize='0.75rem' />
